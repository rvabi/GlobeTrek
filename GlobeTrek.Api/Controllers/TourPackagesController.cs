...
public class TourPackagesController : ControllerBase
{
    ...
    public async Task<IActionResult> Create(CreateTourPackageRequest request)
    {
        ...
        UpdateTourPackageRequest request)
    {
        ...
        package.Accommodation = request.Accommodation.Trim();
        package.Transportation = request.Transportation.Trim();
        package.Activities = request.Activities.Trim();
